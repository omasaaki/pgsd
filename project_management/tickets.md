...
|---------|--------|------------|----------|------------|---------|----------|---------|
| 1 | PGSD-039 | バグ修正 | データベースマネージャー初期化失敗エラー修正 | TODO | High | 3時間 | 2025-07-18 |
| 2 | PGSD-038 | バグ修正 | 設定ファイル使用時のデータベース接続エラー修正 | TODO | High | 4時間 | 2025-07-18 |
| 3 | PGSD-036 | 品質改善 | テストカバレッジ改善 - 80%達成への包括的対応 | TODO | Middle | 8時間 | 2025-07-16 |
...
**工数情報**
- **見積合計**: 127時間（設計23時間 + 実装77時間 + バグ修正25時間 + 品質改善8時間）
- **完了済み工数**: 97時間
- **レビュー待ち工数**: 6時間
- **進行中工数**: 0時間
- **残り見積**: 30時間
