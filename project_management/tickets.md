...
|---------|--------|------------|----------|------------|---------|----------|---------|
| 1 | PGSD-033 | 作業 | CLI引数でsource/targetのスキーマ名を個別指定可能にする | TODO | Middle | 3時間 | 2025-07-15 |
| 2 | PGSD-034 | 作業 | リポート出力方法の改善 - テーブルごとのグルーピング | TODO | Middle | 4時間 | 2025-07-15 |
| 3 | PGSD-035 | 作業 | 先進的なレポートデザインとレイアウトの実装 | TODO | Middle | 6時間 | 2025-07-15 |
...
**工数情報**
- **見積合計**: 106時間（設計23時間 + 実装77時間 + バグ修正6時間）
- **完了済み工数**: 73時間
...
**フェーズ別進捗**
- **設計フェーズ**: 100% (23/23時間)
- **実装フェーズ**: 92% (60/64時間) ※PGSD-009〜029完了/レビュー中
---
