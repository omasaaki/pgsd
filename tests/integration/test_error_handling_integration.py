...
from pgsd.exceptions.base import PGSDError, ErrorSeverity, ErrorCategory
from pgsd.exceptions.database import (
    DatabaseConnectionError, SchemaNotFoundError, QueryExecutionError
)
...
class TestErrorHandlingWorkflow:
    ...
    def test_database_connection_error_workflow(self):
        ...
        with patch('psycopg2.connect') as mock_connect:
            # Create a realistic psycopg2 error
            pg_error = psycopg2.OperationalError("could not connect to server")
            ...
            assert any("PostgreSQL server is running" in suggestion 
    ...
    def test_error_context_propagation(self):
        ...
        assert error_dict["technical_details"]["original_error_type"] == "OperationalError"
    ...
    def test_error_serialization_with_complex_data(self):
        ...
        assert error_dict["technical_details"]["query_plan"]["nodes"][0]["type"] == "SeqScan"
        assert error_dict["technical_details"]["execution_stats"]["rows_examined"] == 1000000
        ...
        assert parsed["technical_details"]["execution_stats"]["execution_time_ms"] == 5000
...
class TestErrorHandlingWithExternalSystems:
    ...
    def test_error_handling_with_file_operations(self):
        ...
        try:
            ...
            assert "nonexistent_config.yaml" in str(config_error)
    ...
    def test_error_handling_with_network_operations(self):
        ...
        with patch('psycopg2.connect') as mock_connect:
            ...
            try:
                ...
                assert network_error.is_retriable()  # Network errors should be retriable
...
class TestErrorHandlingRealWorldScenarios:
    ...
    def test_concurrent_database_operations_error_handling(self):
        ...
        for i in range(10):
            thread = threading.Thread(
                target=simulate_concurrent_operation,
                args=(i,),
                name=f"Operation-{i}"
            )
    ...
    def test_error_handling_with_cleanup_operations(self):
        ...
        try:
            ...
            error.add_context("cleanup_operations", ["close_connections", "clear_cache"])
