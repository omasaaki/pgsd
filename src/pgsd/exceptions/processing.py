...
class SchemaParsingError(ProcessingError):
    ...
    def __init__(
        ...
        if source_file:
            recovery_suggestions.append(f"Review source file for syntax errors: {source_file}")
...
class ComparisonError(ProcessingError):
    ...
    def __init__(
        ...
        if "table" in comparison_step.lower():
            ...
            recovery_suggestions.append("Verify function signatures and implementations")
...
class ReportGenerationError(ProcessingError):
    ...
    def __init__(
        ...
        if report_format.lower() == "html":
            ...
            recovery_suggestions.append("Check for circular references in comparison data")
