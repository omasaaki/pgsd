...
class DatabaseManager:
    ...
    async def initialize(self) -> None:
        ...
        try:
            ...
            self.logger.error("Failed to initialize database manager", extra={
                "error": str(e)
            })
            ...
            raise DatabaseManagerError(
                f"Database manager initialization failed: {str(e)}",
                original_error=e
            )
    ...
    async def get_source_connection(self) -> DatabaseConnector:
        ...
        try:
            ...
            self.logger.error("Failed to get source connection", extra={
                "error": str(e)
            })
            raise DatabaseManagerError(
                f"Failed to get source connection: {str(e)}",
                original_error=e
            )
    ...
    async def get_target_connection(self) -> DatabaseConnector:
        ...
        try:
            ...
            self.logger.error("Failed to get target connection", extra={
                "error": str(e)
            })
            raise DatabaseManagerError(
                f"Failed to get target connection: {str(e)}",
                original_error=e
            )
    ...
    async def verify_connections(self) -> Dict[str, bool]:
        ...
        try:
            ...
            self.logger.error("Source connection verification failed", extra={
                "error": str(e)
            })
        ...
        try:
            ...
            self.logger.error("Target connection verification failed", extra={
                "error": str(e)
            })
            results["target"] = False
        
        self.logger.info("Connection verification completed", extra={
    ...
    async def get_database_versions(self) -> Dict[str, Optional[PostgreSQLVersion]]:
        ...
        try:
            ...
            self.logger.error("Failed to get source database version", extra={
                "error": str(e)
            })
        ...
        try:
            ...
            self.logger.error("Failed to get target database version", extra={
                "error": str(e)
            })
    ...
    async def get_connection_info(self) -> Dict[str, Optional[ConnectionInfo]]:
        ...
        try:
            ...
            self.logger.error("Failed to get source connection info", extra={
                "error": str(e)
            })
        ...
        try:
            ...
            self.logger.error("Failed to get target connection info", extra={
                "error": str(e)
            })
    ...
    async def cleanup_stale_connections(self) -> Dict[str, int]:
        ...
        if total_cleaned > 0:
            self.logger.info(f"Cleaned up {total_cleaned} stale connections", extra={
    ...
    async def _verify_initial_connections(self) -> None:
        ...
        try:
            ...
            min_version = PostgreSQLVersion.parse(DatabaseConstants.MIN_SUPPORTED_VERSION)
            ...
            self.logger.info("Source database connection verified", extra={
                "version": str(version),
        ...
        try:
            ...
            self.logger.info("Target database connection verified", extra={
                "version": str(version),
                "has_permissions": permissions.has_required_permissions()
            })
    ...
    async def close_all(self) -> None:
        ...
        try:
            ...
            self.logger.error("Error closing database connections", extra={
                "error": str(e)
            })
