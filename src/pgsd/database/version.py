...
class VersionManager:
    ...
    def __init__(self):
        ...
        # Supported versions
        self.min_supported_version = PostgreSQLVersion.parse(
            DatabaseConstants.MIN_SUPPORTED_VERSION
        )
        self.recommended_version = PostgreSQLVersion.parse(
            DatabaseConstants.RECOMMENDED_VERSION
        )
    ...
    def check_version_compatibility(self, version: PostgreSQLVersion) -> Dict[str, Any]:
        ...
        if version >= self.recommended_version:
            ...
            compatibility["upgrade_recommendation"] = (
                f"Consider upgrading to PostgreSQL {self.recommended_version} or later"
            )
    ...
    def compare_versions(
        self, version1: PostgreSQLVersion, version2: PostgreSQLVersion
    ) -> Dict[str, Any]:
    ...
    def validate_version_for_operation(
        self, version: PostgreSQLVersion, operation: str
    ) -> bool:
    ...
    def get_version_changelog(
        self, from_version: PostgreSQLVersion, to_version: PostgreSQLVersion
    ) -> List[str]:
    ...
    def parse_version_string(version_string: str) -> PostgreSQLVersion:
        ...
        try:
            ...
            raise DatabaseVersionError(
                f"Invalid version string '{version_string}': {str(e)}", original_error=e
            )
